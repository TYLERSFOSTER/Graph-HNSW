...
and proceeds to build a descending tower $$\text{Tier}_{0}(G)\xrightarrow{\ \ \text{map}^{0}_{1}\ \ }\text{Tier}_{1}(G)\xrightarrow{\ \ map^{1}_{2}\ \ }\text{Tier}_{2}(G)\xrightarrow{  \text{map}^{1}_{2}}\cdots\text{Tier}_{n-1}(G)\xrightarrow{  map^{n-1}_{n}}\text{Tier}_{n-1}(G)$$
